...
const Toast = ({ type, message, onClose, toastsFade, toast_id, position }) => {
    ...
    return (
        ...
        <>
            ...
            <div id={toast_id} className={`flex items-center w-full ${position} rtl:divide-x-reverse  ${typeClasses[type]} ${toastsFade} max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 `} role="alert">
